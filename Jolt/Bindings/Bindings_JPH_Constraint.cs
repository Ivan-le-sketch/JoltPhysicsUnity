...
namespace Jolt
{
    internal static unsafe partial class Bindings
    {
        ...
        public static void JPH_Constraint_WarmStartVelocityConstraint(NativeHandle<JPH_Constraint> constraint, float warmStartInpulseRatio)
        {
            UnsafeBindings.JPH_Constraint_WarmStartVelocityConstraint(constraint, warmStartInpulseRatio);
        }
