...
namespace Jolt
{
    internal static unsafe partial class Bindings
    {
        ...
        public static NativeHandle<JPH_ContactListener> JPH_ContactListener_Create(IContactListener managedListener)
        {
            int truc = 4;
            void* userdata = &truc; 
            var listenerNativeHandle = CreateHandle(UnsafeBindings.JPH_ContactListener_Create(UnsafeContactListenerProcs, &truc));
            ...
            managedContactListeners[(nint)userdata] = managedListener;
        ...
        public static void JPH_ContactListener_DestroyAll()
        {
